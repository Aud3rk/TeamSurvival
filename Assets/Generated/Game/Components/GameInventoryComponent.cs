...
public partial class GameEntity {
    ...
    public void AddInventory(int newWoodCount, int newAppleCount) {
        var index = GameComponentsLookup.Inventory;
        var component = (InventoryComponent)CreateComponent(index, typeof(InventoryComponent));
        component.woodCount = newWoodCount;
        component.appleCount = newAppleCount;
        AddComponent(index, component);
    }

    public void ReplaceInventory(int newWoodCount, int newAppleCount) {
        var index = GameComponentsLookup.Inventory;
        var component = (InventoryComponent)CreateComponent(index, typeof(InventoryComponent));
        component.woodCount = newWoodCount;
        component.appleCount = newAppleCount;
