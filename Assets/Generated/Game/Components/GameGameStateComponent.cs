...
public partial class GameContext {
    ...
    public GameEntity SetGameState(StateGameComponent newValue) {
        if (hasGameState) {
    ...
    public void ReplaceGameState(StateGameComponent newValue) {
...
public partial class GameEntity {
    ...
    public void AddGameState(StateGameComponent newValue) {
