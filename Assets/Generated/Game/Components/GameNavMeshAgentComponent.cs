...
public partial class GameEntity {
    ...
    public void AddNavMeshAgent(Entitas.Entity newMoveEntity) {
        ...
        component.moveEntity = newMoveEntity;
        AddComponent(index, component);
    }

    public void ReplaceNavMeshAgent(Entitas.Entity newMoveEntity) {
        var index = GameComponentsLookup.NavMeshAgent;
        var component = (NavMeshAgentComponent)CreateComponent(index, typeof(NavMeshAgentComponent));
        component.moveEntity = newMoveEntity;
