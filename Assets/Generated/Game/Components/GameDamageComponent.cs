...
public partial class GameEntity {
    ...
    public void AddDamage(UnityEngine.GameObject newDamageReceiver, float newDamage) {
        var index = GameComponentsLookup.Damage;
        var component = (DamageComponent)CreateComponent(index, typeof(DamageComponent));
        component.damageReceiver = newDamageReceiver;
        component.damage = newDamage;
        AddComponent(index, component);
    }

    public void ReplaceDamage(UnityEngine.GameObject newDamageReceiver, float newDamage) {
        var index = GameComponentsLookup.Damage;
        var component = (DamageComponent)CreateComponent(index, typeof(DamageComponent));
        component.damageReceiver = newDamageReceiver;
        component.damage = newDamage;
