...
public partial class ApplicationSurviveContext {
    ...
    public ApplicationSurviveEntity gameSetupEntity { get { return GetGroup(ApplicationSurviveMatcher.GameSetup).GetSingleEntity(); } }
    ...
    public ApplicationSurviveEntity SetGameSetup(GameSetup newValue) {
        if (hasGameSetup) {
...
public partial class ApplicationSurviveEntity {
    ...
    public GameSetupComponent gameSetup { get { return (GameSetupComponent)GetComponent(ApplicationSurviveComponentsLookup.GameSetup); } }
    public bool hasGameSetup { get { return HasComponent(ApplicationSurviveComponentsLookup.GameSetup); } }

    public void AddGameSetup(GameSetup newValue) {
        var index = ApplicationSurviveComponentsLookup.GameSetup;
    ...
    public void RemoveGameSetup() {
        RemoveComponent(ApplicationSurviveComponentsLookup.GameSetup);
    }
}
...
public sealed partial class ApplicationSurviveMatcher {
    ...
    static Entitas.IMatcher<ApplicationSurviveEntity> _matcherGameSetup;

    public static Entitas.IMatcher<ApplicationSurviveEntity> GameSetup {
        get {
            if (_matcherGameSetup == null) {
                var matcher = (Entitas.Matcher<ApplicationSurviveEntity>)Entitas.Matcher<ApplicationSurviveEntity>.AllOf(ApplicationSurviveComponentsLookup.GameSetup);
